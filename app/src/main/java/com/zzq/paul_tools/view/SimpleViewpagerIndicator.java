...
//            canvas.drawRect(lineLeft+((lineRight-lineLeft)-60)/2, height - indicatorHeight, lineRight-((lineRight-lineLeft)-60)/2, height, rectPaint);
            canvas.drawRoundRect(new RectF(lineLeft+((lineRight-lineLeft)-60)/2, height - indicatorHeight,
                    lineRight-((lineRight-lineLeft)-60)/2, height), 10, 10, rectPaint);
